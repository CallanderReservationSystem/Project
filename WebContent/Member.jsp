...
<title>${user}Home(MembersOnly)</title>
</head>
<body>
	<div class="container">
		<div>
			...
			<div id="tabs-2">
				<div class="wrapper">
					<div class="wrapper">
						...
						<ul class="options">
							<li class="active"><a href="#findCalendar">Find a
									Calendar</a></li>
							<li><a href="#unfollowCalendar" data-toggle="collapse"
								aria-expanded="false">Unfollow a Calendar</a>
