...
<body>
	...
	<form method="post" action="RegisterForEvent" id="page">
		Name of the event you want to register to: <input type="text" value="${title}">
		Location of the event you want to register to: <input type="text" value="${location}" readonly>  <br>
		Time: <br> from <input type="text" value="${start}" readonly> to <input type="text" value="${end}" readonly> <br>
