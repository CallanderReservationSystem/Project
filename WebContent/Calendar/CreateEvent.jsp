...
<body>
	...
	<h1>${Calendarname}:Create Event</h1>
	</div>
	<a href="Member">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
		 	<input  class="form-control" type="text" name="eventName" size="45"  value="${param.eventName}" >
		</div>
	</div>
	<br>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input class="form-control" type="text" name= "date" id="datepicker" value="${param.date}">
		</div>
	</div>
	<div>
		<h4>Event Time</h4>
	...
	<div class="form-group">
		<c:if test="${not empty timeSError }">
			...
			<div class="col-sm-10">
			<input class="form-control" type="time" name="startTime" id="startTimepicker" value="${param.startTime}">
			</div>
	</div>
	<div class="form-group">
		<c:if test="${not empty timeEError }">
			...
			<label class="col-sm-2 control-label">End: </label>
			 <div class="col-sm-10">
			<input class="form-control" type="time" name="endTime" id="endTimepicker" value="${param.endTime}">
			</div>
	</div>
	<br>
		<h4>Type of event?</h4>
	...
	<div class="form-group">
		...
		<p>
			<label>Public</label>
			<input type="radio" name="pr" value="public">
		</p>
		<p>
			<label>Private</label>
			<input type="radio" name="pr" value="private">
		</P>
	</div>
		<hr>
	...
	<div class="form-group">
		<c:if test="${not empty locaError }">
			...
			<div class="col-sm-10">
			<input class="form-control" type="text" name="location" size="45" value="${param.location }">
			</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
		<textarea class="form-control" rows="5" cols="35" name="description" style="resize: none;" placeholder="Optional">${param.description}</textarea>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-offset-2 col-sm-10" style="margin-top: 10px">
			<button class="btn btn-success" type="submit" value="Create" onclick="{document.filler.cid.value=${id}; document.filler.submit();}">Create</button>
