...
public class Calander extends HttpServlet {
	...
	// private void printEvents(HttpServletRequest request, HttpServletResponse
	...
	// events.add(new CalendarEventModel(id, userId, calendarId, title,
	// start_date, end_date, start, end, eventUrl, color, tableCount,
	// seatsPerTable));
	// }
